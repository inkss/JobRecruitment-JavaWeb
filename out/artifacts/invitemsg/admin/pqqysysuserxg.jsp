                ...
                <table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#a8c7ce" class="mytab"
                    ...
                    <tr>
                        ...
                        <td width="83%" height="30" align="left" bgcolor="#FFFFFF" class="STYLE19">&nbsp;<textarea
                                ...
                                name='email'></textarea><label id='clabelemail'/></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td width="83%" height="30" align="left" bgcolor="#FFFFFF" class="STYLE19">&nbsp;<span
                                id="weidanx"><label><input type=radio name='wei' value='100人以下'/>&nbsp;100人以下 </label>
...
<label><input type=radio name='wei' value='1000以上'/>&nbsp;1000以上 </label>
                    ...
                    <tr>
                        ...
                        <td width="83%" height="30" align="left" bgcolor="#FFFFFF" class="STYLE19">&nbsp;<span
                                id="zydanx"><label><input type=radio name='zy' value='民营企业'/>&nbsp;民营企业 </label>
...
<label><input type=radio name='zy' value='外资企业'/>&nbsp;外资企业 </label>
                    ...
                    <tr>
                        ...
                        <td width="83%" height="30" align="left" bgcolor="#FFFFFF" class="STYLE19">&nbsp;<input
                                type=text onblur='checkform()' class='' id='xl' name='xl' size=35/><label
                                id='clabelxl'/></td>
                    </tr>
                    <tr>
                        <td width="17%" height="30" align="center" bgcolor="#FFFFFF" class="STYLE19">成立日期</td>
                        <td width="83%" height="30" align="left" bgcolor="#FFFFFF" class="STYLE19">&nbsp;<input
                                type=text size='12' onblur='checkform()' class='' name='cbdate' id='cbdate'
