...
<body>
<!-- servletformstart
  <form  action="/invitemsg/invitemsg?ac=xwhbnewsxg&id=<%=mmm.get("id")%>"     name="f1" method="post"  onsubmit="return checkform()" >
   servletformend -->
<!-- s2formstart -->
<form name="f1" method="post" onsubmit="return checkform()"
      action="/invitemsg/invitemsg!xwhbnewsxg.action?id=<%=mmm.get("id")%>">
    <!--  s2formend -->
            ...
            <td>
                <table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#a8c7ce" class="mytab"
                    ...
                    <tr>
                        ...
                        <td width="83%" height="30" align="left" bgcolor="#FFFFFF" class="STYLE19">&nbsp;<input
                                type=text onblur='checkform()' class='' id='author' name='author' size=35/><label
                                id='clabelauthor'/></td>
                    </tr>
                    <tr>
                        <td width="17%" height="30" align="center" bgcolor="#FFFFFF" class="STYLE19">图片</td>
                    ...
                    <tr>
                        ...
                        <td width="83%" height="30" align="left" bgcolor="#FFFFFF"
                            class="STYLE19"><%=Info.fck(265, mmm.get("content").toString())%>
                        </td>
                    </tr>
