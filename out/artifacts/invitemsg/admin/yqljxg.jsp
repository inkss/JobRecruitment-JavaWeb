...
<body>
<!-- servletformstart
  <form  action="/invitemsg/invitemsg?ac=yqljxg&id=<%=mmm.get("id")%>"     name="f1" method="post"  onsubmit="return checkform()" >
   servletformend -->
<!-- s2formstart -->
<form name="f1" method="post" onsubmit="return checkform()"
      action="/invitemsg/invitemsg!yqljxg.action?id=<%=mmm.get("id")%>">
    <!--  s2formend -->
