...
<%
    ...
    new CommDAO().insert(request, response, "zpinfo", ext, true, false);
%>
<body>
<!-- servletformstart
  <form  action="/invitemsg/invitemsg?ac=zpinfotj&tglparentid=<%=tglparentid%>"     name="f1" method="post"  onsubmit="return checkform()" >
   servletformend -->
<!-- s2formstart -->
<form name="f1" method="post" onsubmit="return checkform()"
      action="/invitemsg/invitemsg!zpinfotj.action?tglparentid=<%=tglparentid%>">
    <!--  s2formend -->
                ...
                <table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#a8c7ce" class="mytab"
                    ...
                    <tr>
                        ...
                        <td width="83%" height="30" align="left" bgcolor="#FFFFFF" class="STYLE19">&nbsp;<span
                                id="xldanx"><label><input type=radio checked=checked name='xl' id='xl' value='高中'/>&nbsp;高中 </label>&nbsp;
...
<label><input type=radio name='xl' id='xl' value='博士'/>&nbsp;博士 </label>&nbsp;
                    ...
                    <tr>
                        ...
                        <td width="83%" height="30" align="left" bgcolor="#FFFFFF" class="STYLE19">&nbsp;<span
                                id="infotypedanx"><label><input type=radio checked=checked name='infotype' id='infotype'
                                                                value='校园招聘'/>&nbsp;校园招聘 </label>&nbsp;
<label><input type=radio name='infotype' id='infotype' value='社会招聘'/>&nbsp;社会招聘 </label>&nbsp;
<label><input type=radio name='infotype' id='infotype' value='定向招聘'/>&nbsp;定向招聘 </label>&nbsp;
                    ...
                    <tr>
                        ...
                        <td width="83%" height="30" align="left" bgcolor="#FFFFFF" class="STYLE19">&nbsp;<textarea
                                cols='45' rows='3' style='margin-top: 1px;margin-bottom: 1px' class=''
                                name='bei'></textarea></td>
                    </tr>
                    <tr>
