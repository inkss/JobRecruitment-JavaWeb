                ...
                <table width="100%" border="0" cellpadding="0" cellspacing="1" class="mytab" onmouseover="changeto()"
                    ...
                    <tr>
                        <td colspan=9 height="30" align="left" bgcolor="#FFFFFF" class="STYLE19">
                            ...
                            招聘类别
                            &nbsp;:&nbsp;
                            <input type=text class='' size=20 name='infotype'/>
                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;

                            <input type=submit class='' value='查询信息'/>
                            &nbsp;&nbsp;
                            <%if (utype.equals("企业")) {%>
                            <input type=button class='' value='添加信息' onclick="window.location.replace('zpinfotj.jsp')"/>
                            <%} %>
                            &nbsp;&nbsp;
                        </td>
                    </tr>
                    ...
                    <tr bgcolor="#F3F8F7">
                        <td height="30" align="center" style="background-color: #F3F8F7;color:#344B50;">招聘标题</td>
                        <td height="30" align="center" style="background-color: #F3F8F7;color:#344B50;">招聘人数</td>
                        <td height="30" align="center" style="background-color: #F3F8F7;color:#344B50;">工作地点</td>
                        ...
                        <td height="30" align="center" style="background-color: #F3F8F7;color:#344B50;">工资待遇</td>
                    ...
                    <%
                        ...
                        if (request.getParameter("qyunameid1") != null) {
                            new CommDAO().commOper("update zpinfo set qyuname ='' where id=" + request.getParameter("qyunameid1"));
                        }
                        if (request.getParameter("qyunameid2") != null) {
                            new CommDAO().commOper("update zpinfo set qyuname ='' where id=" + request.getParameter("qyunameid2"));
                        }
                        ...
                        if (utype.equals("企业")) {
                            sql += "  and (1!=1 ";
                            sql += "  or  qyuname like'%" + Info.getUser(request).get("uname") + "%') ";
                        }
                    ...
                    <tr>
                        ...
                        <td height="30" align="center" bgcolor="#FFFFFF" class="STYLE19"><%=map.get("zprs")%>
                        </td>
                        <td height="30" align="center" bgcolor="#FFFFFF" class="STYLE19"><%=map.get("gzdd")%>
                        </td>
                        <td height="30" align="center" bgcolor="#FFFFFF" class="STYLE19"><%=map.get("xl")%>
                        </td>
                        <td height="30" align="center" bgcolor="#FFFFFF" class="STYLE19"><%=map.get("infotype")%>
                        </td>
                        <td height="30" align="center" bgcolor="#FFFFFF" class="STYLE19"><%=map.get("dy")%>
                        </td>
                        ...
                        <td height="30" align="center" bgcolor="#FFFFFF" class="STYLE19">
                            <a href="zpinfoxg.jsp?id=<%=map.get("id")%>">修改</a>
                            &nbsp;&nbsp;|&nbsp;&nbsp;&nbsp;

                            <a onclick="return confirm('确定要删除这条记录吗?')"
                               href="zpinfocx.jsp?scid=<%=map.get("id")%>">删除</a>
                        </td>
                    </tr>
                    <%}%>
