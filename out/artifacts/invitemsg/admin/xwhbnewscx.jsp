            ...
            <td>
                <table width="100%" border="0" cellpadding="0" cellspacing="1" class="mytab" onmouseover="changeto()"
                    ...
                    <tr>
                        <td colspan=5 height="30" align="left" bgcolor="#FFFFFF" class="STYLE19">
                            ...
                            <input type=button class='' value='添加信息'
                                   onclick="window.location.replace('xwhbnewstj.jsp')"/>
                            &nbsp;&nbsp;
                        </td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td height="30" align="center" bgcolor="#FFFFFF" class="STYLE19"><%=map.get("author")%>
                        </td>
                        ...
                        <td height="30" align="center" bgcolor="#FFFFFF" class="STYLE19">
                            ...
                            <a onclick="return confirm('确定要删除这条记录吗?')"
                               href="xwhbnewscx.jsp?scid=<%=map.get("id")%>">删除</a>
                        </td>
                    </tr>
                    <%}%>
