...
<body>
<!-- servletformstart
  <form  action="/invitemsg/invitemsg?ac=sysuserxg&id=<%=mmm.get("id")%>"     name="f1" method="post"  onsubmit="return checkform()" >
   servletformend -->
<!-- s2formstart -->
<form name="f1" method="post" onsubmit="return checkform()"
      action="/invitemsg/invitemsg!sysuserxg.action?id=<%=mmm.get("id")%>">
    <!--  s2formend -->
...
//ajax.post(encodeURI("/invitemsg/factory/checkno.jsp?table=sysuser&col=uname&value="+unameobj.value+"&checktype=update&id=<%=mmm.get("id")%>&ttime=<%=Info.getDateStr()%>")); 
