...
function uploadimg() {
    pop("/invitemsg/js/uploadimg.jsp", "上传图片", 300, 77)
}


function uploadimg2() {
    pop("/invitemsg/js/uploadimg2.jsp", "上传图片", 300, 77)
}

function uploadimg3() {
    pop("/invitemsg/js/uploadimg3.jsp", "上传图片", 300, 77)
}

function uploadimg4() {
    pop("/invitemsg/js/uploadimg4.jsp", "上传图片", 300, 77)
}


function uploadimg5() {
    pop("/invitemsg/js/uploadimg5.jsp", "上传图片", 300, 77)
}


function uploaddoc() {
    pop("/invitemsg/js/uploaddoc.jsp", "docupload", 300, 77)
}
...
Popup.prototype = {
    ...
    build: function () {
        ...
        var close = '<img id="dialogBoxClose" title="关闭" src=/invitemsg/js/dialogclose.gif  />';
