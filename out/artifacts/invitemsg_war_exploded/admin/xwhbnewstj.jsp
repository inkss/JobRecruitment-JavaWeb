...
<body>
<!-- servletformstart
  <form  action="/invitemsg/invitemsg?ac=xwhbnewstj&tglparentid=<%=tglparentid%>"     name="f1" method="post"  onsubmit="return checkform()" >
   servletformend -->
<!-- s2formstart -->
<form name="f1" method="post" onSubmit="return checkform()"
      action="/invitemsg/invitemsg!xwhbnewstj.action?tglparentid=<%=tglparentid%>">
    <!--  s2formend -->
