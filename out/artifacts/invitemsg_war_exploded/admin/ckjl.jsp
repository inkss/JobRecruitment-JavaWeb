        ...
        <tr>
            <td>
                <table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#a8c7ce" class="mytab"
                    ...
                    <tr>
                        <td width="17%" height="30" align="center" bgcolor="#FFFFFF" class="STYLE19">获奖证书</td>
                        <td width="83%" height="30" align="left" bgcolor="#FFFFFF" class="STYLE19">&nbsp;
                            <img src="../upfile/<%=mmm.get("filename2") %>" height="65"/>
                        </td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td width="83%" height="30" align="left" bgcolor="#FFFFFF" class="STYLE19">&nbsp;
                            <a href="../upload?filename=<%=mmm.get("docname3")%>">点击下载</a>
                        </td>
                    </tr>
