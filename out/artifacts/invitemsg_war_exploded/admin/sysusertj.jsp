...
<body>
<!-- servletformstart
  <form  action="/invitemsg/invitemsg?ac=sysusertj&tglparentid=<%=tglparentid%>"     name="f1" method="post"  onsubmit="return checkform()" >
   servletformend -->
<!-- s2formstart -->
<form name="f1" method="post" onsubmit="return checkform()"
      action="/invitemsg/invitemsg!sysusertj.action?tglparentid=<%=tglparentid%>">
    <!--  s2formend -->
                ...
                <table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#a8c7ce" class="mytab"
                    ...
                    <tr>
                        ...
                        <td width="83%" height="30" align="left" bgcolor="#FFFFFF" class="STYLE19">&nbsp;<input
                                type=text onblur='checkform()' class='' id='uname' name='uname' size=35/><label
                                id='clabeluname'/></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td width="83%" height="30" align="left" bgcolor="#FFFFFF" class="STYLE19">&nbsp;<span
                                id="sexdanx"><label><input type=radio checked=checked name='sex' id='sex' value='男'/>&nbsp;男 </label>&nbsp;
<label><input type=radio name='sex' id='sex' value='女'/>&nbsp;女 </label>&nbsp;
                    ...
                    <tr>
                        <td width="17%" height="30" align="center" bgcolor="#FFFFFF" class="STYLE19">地址</td>
                        <td width="83%" height="30" align="left" bgcolor="#FFFFFF" class="STYLE19">&nbsp;<input
                                type=text onblur='checkform()' class='' id='addrs' name='addrs' size=35/><label
                                id='clabeladdrs'/></td>
                    </tr>
                    <tr>
...
<script language=javascript>
    ...
    function checkform() {
        ...
        if (unameobj.value != "") {
            var ajax = new AJAX();
//ajax.post(encodeURI("/invitemsg/factory/checkno.jsp?table=sysuser&col=uname&value="+unameobj.value+"&checktype=insert&ttime=<%=Info.getDateStr()%>")) 
