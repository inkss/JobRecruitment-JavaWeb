...
public class Info {
    ...
    public static void writeExcel(String fileName, String prosstr, java.util.List<List> list, HttpServletRequest request, HttpServletResponse response) {
        ...
        try {
            response.sendRedirect("/invitemsg/upload?filename=" + fileName.substring(fileName.lastIndexOf("/") + 1));
        } catch (IOException e) {
            e.printStackTrace();
        }
    ...
    public static String getFileUpInfo() {
        String jscode = "";
        jscode += "<script src=/invitemsg/js/popup.js></script>";
        jscode += "<font onclick=\"uploaddoc()\" src=\"js/nopic.jpg\" style='cursor:hand' id=txt3 >点击此处上传</font>";
        ...
        try {
            ...
            while (it.hasNext()) {
                ...
                if (!str1.equals("content")) {
                    ...
                    jscode += "{\n";
                    jscode += "document.getElementById(\"txt\").src=\"/invitemsg/upfile/" + map.get("filename") + "\";\n";
                    jscode += "}\n";

                    jscode += "if(document.getElementById(\"txt2\"))\n";
                    jscode += "{\n";
                    jscode += "document.getElementById(\"txt2\").src=\"/invitemsg/upfile/" + map.get("filename2") + "\";\n";
                    jscode += "}\n";

                    jscode += "if(document.getElementById(\"txt3\"))\n";
                    jscode += "{\n";
                    jscode += "document.getElementById(\"txt3\").src=\"/invitemsg/upfile/" + map.get("filename3") + "\";\n";
                    jscode += "}\n";

                    jscode += "if(document.getElementById(\"txt4\"))\n";
                    jscode += "{\n";
                    jscode += "document.getElementById(\"txt4\").src=\"/invitemsg/upfile/" + map.get("filename4") + "\";\n";
                    jscode += "}\n";

                    jscode += "if(document.getElementById(\"txt5\"))\n";
                    jscode += "{\n";
                    jscode += "document.getElementById(\"txt5\").src=\"/invitemsg/upfile/" + map.get("filename5") + "\";\n";
                    jscode += "}\n";
    ...
    public static String getImgUpInfoext(int height) {
        String jscode = "";
        jscode += "<img style=\"cursor: hand\" onclick=\"uploadimg()\" src=\"/invitemsg/js/nopic.jpg\" id=txt height=\"" + height + "\"/>";
        jscode += "<input type=hidden name=\"filename\" id=\"filename\" value=\"\" />";
        jscode += "<script type=\"text/javascript\"  src=\"/invitemsg/js/popupsext.js\"></script>";
        return jscode;
    }

    public static String getImgUpInfoext2(int height) {
        String jscode = "";
        jscode += "<img style=\"cursor: hand\" onclick=\"uploadimg2()\" src=\"/invitemsg/js/nopic.jpg\" id=txt2 height=\"" + height + "\"/>";
    ...
    public static String getImgUpInfoext3(int height) {
        String jscode = "";
        jscode += "<img style=\"cursor: hand\" onclick=\"uploadimg3()\" src=\"/invitemsg/js/nopic.jpg\" id=txt3 height=\"" + height + "\"/>";
    ...
    public static String getImgUpInfo(int height) {
        ...
        jscode += "<img style=\"cursor: hand\" onclick=\"uploadimg()\" src=\"/invitemsg/js/nopic.jpg\" id=txt height=\"" + height + "\"/>";
        jscode += "<input type=hidden name=\"filename\" id=\"filename\" value=\"\" />";
        jscode += "<script type=\"text/javascript\"  src=\"/invitemsg/js/popups.js\"></script>";
        return jscode;
    }
    ...
    public static String getImgUpInfo2(int height) {
        ...
        jscode += "<img style=\"cursor: hand\" onclick=\"uploadimg2()\" src=\"/invitemsg/js/nopic.jpg\" id=txt2 height=\"" + height + "\"/>";
        jscode += "<input type=hidden name=\"filename2\" id=\"filename2\" value=\"\" />";
        jscode += "<script type=\"text/javascript\"  src=\"/invitemsg/js/popup.js\"></script>";
        return jscode;
    }
    ...
    public static String getImgUpInfo4(int height) {
        String jscode = "";
        jscode += "<img style=\"cursor: hand\" onclick=\"uploadimg4()\" src=\"/invitemsg/js/nopic.jpg\" id=txt4 height=\"" + height + "\"/>";
    ...
    public static String getImgUpInfo5(int height) {
        String jscode = "";
        jscode += "<img style=\"cursor: hand\" onclick=\"uploadimg5()\" src=\"/invitemsg/js/nopic.jpg\" id=txt5 height=\"" + height + "\"/>";
    ...
    public static String fck(int height, String content) {
        ...
        jscode += "<script type=\"text/javascript\"  src=\"/invitemsg/fckeditor/fckeditor.js\"></script>";
        jscode += "<script language=\"javascript\">";
        jscode += "function fckinit()";
        jscode += "{";
        jscode += " var of = new FCKeditor(\"content\");";
        jscode += "of.BasePath=\"/invitemsg/fckeditor/\";";
    ...
    public static String getCol(String type, String trid, String name, String url, String display) {
        ...
        if (type.equals("A")) {
            html += "<tr  onClick=\"show('" + trid + "')\"  style=\"cursor:hand\"> ";
            html += "<td height=\"23\" background=\"images/main_34.gif\"><table width=\"100%\" border=\"0\" cellspacing=\"0\" cellpadding=\"0\"> ";
            html += "<tr> ";
            html += "<td width=\"9%\">&nbsp;</td> ";
            html += "<td width=\"83%\"><div align=\"center\" class=\"STYLE5\">" + name + "</div></td> ";
            html += "<td width=\"8%\">&nbsp;</td> ";
            html += "</tr> ";
            html += "</table></td> ";
            html += "</tr>  ";
            html += "<tr> ";
            html += "<td valign=\"top\"><div align=\"center\"> ";
        }

        if (type.equals("B")) {
            html += "<table width=\"82%\" border=\"0\" id=\"" + trid + "@" + mid + "\"  style=\"display: " + display + "\"   align=\"center\" cellpadding=\"0\" cellspacing=\"0\"> ";
            html += "<tr> ";
            html += "<td height=\"38\"><table width=\"100%\" border=\"0\" cellspacing=\"0\" cellpadding=\"0\"> ";
            html += "<tr> ";
            html += "<td width=\"33\" height=\"28\"><img src=\"images/main_46.gif\" width=\"28\" height=\"28\"></td> ";
            html += "<td width=\"99\"><table width=\"100%\" border=\"0\" cellspacing=\"0\" cellpadding=\"0\"> ";
            html += "<tr> ";
            html += "<td onClick=\"go('" + url + "')\" height=\"23\" class=\"STYLE4\" style=\"cursor:hand\" onMouseOver=\"this.style.backgroundImage='url(images/tab_bg.gif)';this.style.borderStyle='solid';this.style.borderWidth='1';borderColor='#adb9c2'; \"onmouseout=\"this.style.backgroundImage='url()';this.style.borderStyle=''\">" + name + "</td> ";
            html += "</tr>   ";
            html += "</table></td>   ";
            html += "</tr>      ";
            html += "</table></td> ";
