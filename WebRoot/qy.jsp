                                                ...
                                                <TD class=css vAlign=top align=left>
                                                    <TABLE border=0 cellSpacing=0 cellPadding=0
                                                        ...
                                                        <TR>
                                                            <TD class=css align=left height="76">
                                                                ...
                                                                所在城市 : <input type=text name="houhold" id="houhold"
                                                                              size="10" style="height: 15px"/>
                                                                &nbsp;
                                                                企业规模 : <input type=text name="wei" id="wei" size="10"
                                                                              style="height: 15px"/>
                                                                ...
                                                                &nbsp;&nbsp;&nbsp;&nbsp;
                                                                行业类别 : <input type=text name="xl" id="xl" size="10"
                                                                              style="height: 15px"/>
                                                                &nbsp;
                                                                公司性质 : <input type=text name="zy" id="zy" size="10"
                                                                              style="height: 15px"/>
                                                                &nbsp;
                                                        ...
                                                        <%
                                                            ...
                                                            PageManager pageManager = PageManager.getPage("qy.jsp?1=1", 8, request);
