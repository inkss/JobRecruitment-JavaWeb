                ...
                <table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#a8c7ce" class="mytab"
                    ...
                    <tr>
                        ...
                        <td width="79%" height="30" align="left" bgcolor="#FFFFFF" class="STYLE19">
                            &nbsp;<%=Info.getselect("touname", "sysuser", "tname~无名", "utype='企业'")%>
                            <label id='clabeltouname'/>
                        </td>
                        <%} else { %>
                        <td width="79%" height="30" align="left" bgcolor="#FFFFFF" class="STYLE19">
                            &nbsp;<%=Info.getselect("touname", "sysuser", "tname~无名", "utype='求职者'")%>
                            <label id='clabeltouname'/>
                        </td>
                        <%} %>
                    </tr>
                    <tr>
                        ...
                        <td width="79%" height="30" align="left" bgcolor="#FFFFFF" class="STYLE19">&nbsp;<textarea
                                cols='35' style='margin-top: 1px;margin-bottom: 1px' class=''
                                name='tcontent'></textarea></td>
                    </tr>
