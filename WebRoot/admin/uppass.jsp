...
<body>
<form action="/invitemsg/invitemsg?ac=uppass" name="f1" method="post">
    <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
        ...
        <tr>
            <td>
                <table width="100%" border="0" cellpadding="0" cellspacing="0" class="mytab" onMouseOver="changeto()"
                    ...
                    <tr>
                        ...
                        <td width="27%" height="30" align="left" bgcolor="#FFFFFF" class="STYLE19"> &nbsp;<input
                                type="password" name="userpass"/></td>
                    </tr>
                    <tr>
                        <td width="16%" height="30" align="center" bgcolor="#FFFFFF" class="STYLE19">请重复新密码</td>
                        <td width="27%" height="30" align="left" bgcolor="#FFFFFF" class="STYLE19">&nbsp;<input
                                type="password" name="copyuserpass"/></td>
                    </tr>
                    <tr>
