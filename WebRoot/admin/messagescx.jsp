                                    ...
                                    <td>
                                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                            <tr>
                                                ...
                                                <td width="97%" valign="bottom"><span class="STYLE1"> 留言管理</span></td>
                                            </tr>
                                        </table>
                                    </td>
                                    <td>
            ...
            <td>
                <table width="100%" border="0" cellpadding="0" cellspacing="1" class="mytab" onmouseover="changeto()"
                    ...
                    <tr bgcolor="#F3F8F7">
                        ...
                        <td height="30" align="center" style="background-color: #F3F8F7;color:#344B50;">回复</td>
                    ...
                    <%
                        ...
                        String url = "messagescx.jsp?1=1&saver=" + psaver + "&savetime=" + startsavetime + "&savetime=" + endsavetime + "&content=" + pcontent + "";
                        ArrayList<HashMap> list = PageManager.getPages(url, 5, sql, request);
                        for (HashMap map : list) { %>
                    <tr>

                        <td height="30" align="center" bgcolor="#FFFFFF" class="STYLE19"><%=map.get("saver")%>
                        </td>
                        <td height="30" align="center" bgcolor="#FFFFFF" class="STYLE19"><%=map.get("savetime")%>
                        </td>
                        <td height="30" align="center" bgcolor="#FFFFFF" class="STYLE19"><%=map.get("content")%>
                        </td>
                        <td height="30" align="center" bgcolor="#FFFFFF" class="STYLE19"><%=map.get("recontent")%>
                        </td>
                        <td height="30" align="center" bgcolor="#FFFFFF" class="STYLE19">
                            ...
                            <a onclick="return confirm('确定要删除这条记录吗?')"
                               href="messagescx.jsp?scid=<%=map.get("id")%>">删除</a>
                        </td>
                    </tr>
                    <%}%>
