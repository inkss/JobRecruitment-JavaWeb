...
<body>
<!-- servletformstart
  <form  action="/invitemsg/invitemsg?ac=messagesxg&id=<%=mmm.get("id")%>"     name="f1" method="post"  onsubmit="return checkform()" >
   servletformend -->
<!-- s2formstart -->
<form name="f1" method="post" onsubmit="return checkform()"
      action="/invitemsg/invitemsg!messagesxg.action?id=<%=mmm.get("id")%>">
    <!--  s2formend -->
        ...
        <tr>
            <td>
                <table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#a8c7ce" class="mytab"
                    ...
                    <tr>
                        <td width="17%" height="30" align="center" bgcolor="#FFFFFF" class="STYLE19">回复</td>
                        <td width="83%" height="30" align="left" bgcolor="#FFFFFF" class="STYLE19">&nbsp;<textarea
                                ...
                                class='' name='recontent'></textarea></td>
                    </tr>
