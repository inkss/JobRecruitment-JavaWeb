...
<HEAD><TITLE>欢迎进入系统后台</TITLE>
    <LINK
            href="/invitemsg/admin/images/syscome.files/Admin.css" rel=stylesheet>
    <SCRIPT language=javascript src="/invitemsg/admin/images/syscome.files/Admin.js"></SCRIPT>
...
<script type="text/javascript">
    ...
    txt.src = "/invitemsg/upfile/<%=filename%>";
    popclose();
</script>
<%} %>
<form action="/invitemsg/invitemsg?ac=uploadimg2" enctype="multipart/form-data" name="f1" method="post">
    <TABLE cellSpacing=1 cellPadding=3 width="100%" align=center
        ...
        <TR>
            <TD height=31 align="center" class=forumrow>
                <input type="submit" name="Submit" value="提交信息">&nbsp;&nbsp;&nbsp;<input type="reset" name="Submit"
                                                                                         value="重新填写"></TD>
        </TR>
    </TABLE>
</form>
...
<script type="text/javascript">
   ...
   if(suc!=null)
   {
    %>
    alert("操作成功");
    parent.location.replace("/invitemsg/admin/kcfiles.jsp");
    <%}%>
</script>
